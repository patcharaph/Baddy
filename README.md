...
โดยไม่ต้องมี DB (ปัจจุบัน 183 เทสต์ ครอบ engine, mapper, ตัวตรวจ id token ของ LINE,
...
กติกาการเข้ารอบ ลิงก์เชิญ และตัวตรวจฟอร์ม (เปิดรอบ/แก้รอบ) ใน `domain/` ด้วยเป็น 139
รวมทั้งโปรเจกต์ 183
